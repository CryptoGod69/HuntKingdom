 ...
 * @author Omar
 */
public class NewTopicForm extends BaseForm {
        
    public NewTopicForm(Resources res) {
...
//********PARTIE TOPICS********//
        ...
        ok.addActionListener(e -> TopicService.getInstance().addTopic(res, new Topic(title.getText(), "Omar"))); //A CHANGER !!!!!!!!
